...
<body>
	...
	<div id="body">
		...
		<div  id="transation">
		<form action="kycUpdate?id=<%=id%>" method="post">
				
				<input type="number"  name="front-end-AddharNumaber" value="<%=accountdetails.getAddharNumber()%>" readonly="readonly"> 
				<input type="number"  name="front-end-phoneNumaber" value="<%=accountdetails.getPhoneNumber()%>" > 
		
			
			<section id="dtn-3"><button>update</button></section>
