...
<body>
	...
	<div id="body">
		...
		<div  id="transation">
		<form action="addBalance?id=<%=id%>" method="post">
				
				<input type="number"  placeholder=" Enter balance to deposit" name="front-end-balance"> 
		
			
			<section id="dtn-3"><button>Add</button></section>
